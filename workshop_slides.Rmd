...
Is an existing simple production ready package available on GitHub they can [fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo).

Packaged Shiny app XXX that has been built in the workshop "Is R ready for Production? Let’s develop a Professional Shiny Application!"

Summary of Vanlog’s workshop app
...
LIVE: Make an example that looks innocuous but fails. One does not want to rely on people manually running checks before committing.
...
Travis CI is an open-source hosted continuous integration service that can be used to build and test software projects hosted on GitHub.
...
New development items are usually recorded on GitHub as Issues.

[How to create a new Issue](https://help.github.com/en/github/managing-your-work-on-github/creating-an-issue)
...
The deveopment associated with each issue should, in principle, occurr in a separate `feature` branch, for the separation of concerns between different developments. 

[How to create a new branch](https://help.github.com/en/github/collaborating-with-issues-and-pull-requests/creating-and-deleting-branches-within-your-repository)
...
LIVE show how to set branches controls
...
Compared to Travis CI, in GitHub Actions each step here needs to be explicitly specified. Moreover, for the time being, GitHub Actions does not support a hierarchical, aggregated structure of actions.
...
Part of DevOps is to streamline the deployment process. This can be done as automatic / continuous deployment. We are going to integrate this step in the GitHub Actions workflow.
...
You can have a look at out techguides for support.
